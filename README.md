...
- [ ] User can like a post and see number of likes for each post in the post details screen.
      -Partially implemented: User is able to like and it saves the like but still working on updating the like icon after user likes the post
...
<img src='54I-MvwF.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
